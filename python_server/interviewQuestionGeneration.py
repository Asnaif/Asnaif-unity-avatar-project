...
#     "experience": ""
# }
def interviewQuestionGeneration(extractedText, formData, model_type: str = "openai", **model_kwargs):
    ...
    #     temperature=1
    # )
    provider = ModelFactory.create_provider(model_type, **model_kwargs)  # pyright: ignore[reportUndefinedVariable]
    
    # New/Correct Call:
    return provider.generate(formattedTemplateQA)
